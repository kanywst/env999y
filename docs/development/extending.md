...
- [Envoy 拡張ガイド](#envoy-拡張ガイド)
  - [拡張ポイント](#拡張ポイント)
  - [拡張機能の開発方法](#拡張機能の開発方法)
  - [コア拡張機能の開発](#コア拡張機能の開発)
    - [1. 開発環境のセットアップ](#1-開発環境のセットアップ)
    - [2. 拡張機能の基本構造](#2-拡張機能の基本構造)
      - [ディレクトリ構造](#ディレクトリ構造)
      - [フィルターの実装](#フィルターの実装)
      - [ファクトリーとコンフィグの実装](#ファクトリーとコンフィグの実装)
      - [BUILD ファイル](#build-ファイル)
    - [3. 拡張機能の登録](#3-拡張機能の登録)
    - [4. 拡張機能のテスト](#4-拡張機能のテスト)
  - [WASM拡張機能の開発](#wasm拡張機能の開発)
    - [1. 開発環境のセットアップ](#1-開発環境のセットアップ-1)
    - [2. プロジェクト構造](#2-プロジェクト構造)
    - [3. フィルターの実装](#3-フィルターの実装)
    - [4. ビルドとデプロイ](#4-ビルドとデプロイ)
  - [Lua フィルターを使用した拡張](#lua-フィルターを使用した拡張)
    - [Lua フィルターの設定例](#lua-フィルターの設定例)
  - [ベストプラクティス](#ベストプラクティス)
    - [1. 適切な拡張方法の選択](#1-適切な拡張方法の選択)
    - [2. パフォーマンスの考慮](#2-パフォーマンスの考慮)
    - [3. テストの重要性](#3-テストの重要性)
    - [4. ドキュメント](#4-ドキュメント)
  - [まとめ](#まとめ)
