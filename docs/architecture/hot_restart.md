...
<details><summary>Graceful Shutdown vs Draining</summary>

| 特徴 | Graceful Shutdown | Draining |
| --- | ----------------- | --------- |
| 目的 | Envoyプロセス全体を安全に終了させること。| 新しい接続を受け付けず、既存の接続を優雅に終了させること。 |
| 範囲 | プロセス全体の終了、リソースの解放。 | 主にリスナーと接続のライフサイクル管理。 |
| 実行時期 | Envoyのプロセス停止がトリガーされたとき。| リスナー設定更新時、またはシャットダウン直前のフェーズ。 |
| 結果 | プロセスが停止し、メモリから解放される。 | ドレイン期間後、関連リソースが削除され、プロセスがシャットダウンに進む。 |
